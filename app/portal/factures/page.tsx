...
export default async function PortalInvoicesPage() {
    ...
    const unpaidTotal = (factures || [])
        ...
        .reduce((sum: number, f: any) => sum + (f.amountTTC || 0), 0)
                    ...
                    <TableBody>
                        {(factures || []).map((facture: any) => (
                            <TableRow key={facture.id} className="hover:bg-slate-50/50 transition-colors">
                                ...
                                <TableCell className="text-slate-600">{formatDate(facture.issueDate)}</TableCell>
                                ...
                                <TableCell className="text-right font-bold text-slate-900">
                                    {formatCurrency(facture.amountTTC || 0)}
                                </TableCell>
