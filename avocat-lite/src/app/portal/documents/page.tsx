                    ...
                    <Card className="border-none shadow-sm">
                        <CardContent className="p-0">
                            <div className="grid grid-cols-1 divide-y divide-slate-100">
                                {client.dossiers.flatMap((d: any) => d.documents).length === 0 ? (
                                    ...
                                    client.dossiers.flatMap((d: any) => d.documents).map((doc: any) => (
                                        <div key={doc.id} className="p-4 sm:p-6 flex items-center justify-between hover:bg-slate-50 transition-colors group">
                                            <div className="flex items-center gap-4 sm:gap-6">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-xs text-slate-500 mt-1 flex items-center gap-3">
                                                        <span>Mis à jour le {formatDate(doc.updatedAt)}</span>
