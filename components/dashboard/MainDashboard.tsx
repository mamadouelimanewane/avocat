...
import { LegalIntelligenceWidget } from '@/components/ai/LegalIntelligenceWidget';
...
async function getStats() {
    try {
        ...
        const [dossierCount, agenda, legalWatch, tasksPending] = await Promise.all([
...
export default async function MainDashboard() {
    ...
    return (
        <div className="flex-1 space-y-8 pb-20">
            ...
            {/* HERO BRANDING SECTION (Bringing the Landing Page Style here) */}
                ...
                <div className="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-8">
                    <div className="max-w-2xl">
                        ...
                        <p className="text-slate-400 text-lg font-light max-w-lg">
                            Bonjour Maître. {insight} Votre écosystème d'excellence est prêt.
                        </p>
                    </div>
            ...
            <div className="space-y-4">
                <div className="flex items-center gap-2 px-2">
                    ...
                    <h2 className="text-lg font-black text-slate-900 uppercase tracking-tighter">Accès Direct</h2>
                </div>
                <ModuleGrid />
            </div>
            ...
            <div className="grid gap-8 md:grid-cols-6">
                ...
                <div className="md:col-span-2">
                    <div className="bg-slate-950 rounded-[2.5rem] p-8 shadow-2xl h-full border border-slate-800">
                        <h2 className="text-lg font-black text-white mb-6 uppercase tracking-tighter underline decoration-amber-500 decoration-4 underline-offset-8">Agenda</h2>
                        <SmartAgenda events={stats.agenda} />
                    </div>
                </div>
            </div>

            {/* VEILLE JURIDIQUE & INTELLIGENCE */}
            <div className="grid gap-8 md:grid-cols-2">
                <div className="bg-white rounded-[2rem] border border-slate-200 p-8 shadow-sm">
                    <h2 className="text-lg font-black text-slate-900 mb-6 uppercase tracking-tighter text-indigo-700">LexAI Intelligence</h2>
                    <LegalIntelligenceWidget />
                </div>
                <div className="bg-white rounded-[2rem] border border-slate-200 p-8 shadow-sm">
                    <h2 className="text-lg font-black text-slate-900 mb-6 uppercase tracking-tighter text-emerald-700">Veille LexConnect</h2>
